    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_type', models.CharField(choices=[('ShortAnswerProblem', 'Shortanswerproblem'), ('DescriptiveProblem', 'Descriptiveproblem'), ('Problem', 'Problem')], default='DescriptiveProblem', max_length=20, verbose_name='نوع')),
                ('title', models.CharField(max_length=100, verbose_name='عنوان')),
                ('text', models.TextField(verbose_name='متن')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problems', models.ManyToManyField(blank=True, related_name='groups', to='problembank.Problem', verbose_name='مسئله(ها)')),
            ],
        ),
        migrations.AddField(
            model_name='problem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('problem_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='problembank.problem')),
                ('answer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='problem', to='problembank.descriptiveanswer', verbose_name='پاسخ صحیح')),
            ],
            bases=('problembank.problem',),
        ),
    ]
