    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentors', models.ManyToManyField(related_name='editable_events', to='problembank.BankAccount', verbose_name='همیار(ها)')),
                ...
                ('prticipants', models.ManyToManyField(related_name='participated_events', to='problembank.BankAccount', verbose_name='بیننده(ها)')),
            ],
        ),
        migrations.CreateModel(
            name='Problem',
