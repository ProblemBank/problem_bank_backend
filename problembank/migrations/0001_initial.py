# Generated by Django 3.2.3 on 2021-09-05 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('ShortAnswer', 'Shortanswer'), ('Descriptive', 'Descriptive')], default='Descriptive', max_length=20, verbose_name='نوع')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem', to='problembank.bankaccount', verbose_name='نویسنده')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('respondents', models.ManyToManyField(related_name='shortanswersubmit', to='problembank.BankAccount', verbose_name='پاسخ دهنده (ها)')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='عنوان')),
                ('mentors', models.ManyToManyField(blank=True, related_name='editable_categories', to='problembank.BankAccount', verbose_name='همیار(ها)')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_categories', to='problembank.bankaccount', verbose_name='صاحب')),
                ('problems', models.ManyToManyField(blank=True, related_name='categories', to='problembank.Problem', verbose_name='مسئله(ها)')),
                ('viewers', models.ManyToManyField(blank=True, related_name='observable_categories', to='problembank.BankAccount', verbose_name='بیننده(ها)')),
            ],
        ),
        migrations.CreateModel(
