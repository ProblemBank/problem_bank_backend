...
class ProblemCategory(models.Model):
    ...
    owner = models.ForeignKey(BankAccount, null=True, on_delete=models.SET_NULL, verbose_name='صاحب',
                              related_name='owned_categories')
    mentors = models.ManyToManyField(BankAccount, verbose_name='همیار(ها)', blank=True,
                                     related_name='editable_categories')
    viewers = models.ManyToManyField(BankAccount, verbose_name='بیننده(ها)', blank=True,
                                     related_name='observable_categories')
    # roles
